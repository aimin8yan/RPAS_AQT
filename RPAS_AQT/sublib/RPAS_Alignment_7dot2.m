function val=RPAS_Alignment_7_dot_2(in)
  ...
  val=struct(...
      'X_in_pixels', x,...
      'X_in_mu_image_plane', x*RPAS_C.Pixel_img_plane, ...
      'X_in_mu_in_object_plane', x*RPAS_C.Pixel_obj_plane, ...
      'Y_in_pixels', y,...
      'Y_in_mu_image_plane', y*RPAS_C.Pixel_img_plane, ...
      'Y_in_mu_in_object_plane', y*RPAS_C.Pixel_obj_plane, ...
      'Rz', Rz);
  return;
end
